...
def dis_choise(pwin):
    ...
    dc_win.resizable(0,0)

    dc_label = Label(dc_win, text = 'Диcциплины:', font = ww.font_other)

    dc_list = Listbox(dc_win, height = 8, width = 25, selectmode = SINGLE, font = ww.font_other)
...
def raz_test_form(par_rt):
    ...
    try:
        ...
        tf_raz_label = Label(tform, text = 'Выберите\nодин или несколько\nразделов', font = ww.font_other)

        tf_raz_list = Listbox(tform, height = 10, width = 25, selectmode = MULTIPLE, font = ww.font_other)
        ...
        tf_var_label = Label(tform, text = 'Количество вариантов', font = ww.font_other, width = 25)
